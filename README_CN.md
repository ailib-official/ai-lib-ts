...
**[AI-Protocol](https://github.com/ailib-official/ai-protocol) 协议运行时** — TypeScript / Node.js 参考实现（v**1.2.0**）。
...
已发布到 [npm](https://www.npmjs.com/package/@ailib-official/ai-lib-ts)：**`@ailib-official/ai-lib-ts@1.2.0`**。可选 peer：`@ailib-official/ai-protocol@^1.0.0`。
